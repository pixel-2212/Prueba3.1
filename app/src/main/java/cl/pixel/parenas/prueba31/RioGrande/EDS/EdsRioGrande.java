...
public class EdsRioGrande extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eds_rio_grande);
        ...
        if (db != null) {
            ...
            ListView opc = (ListView)findViewById(R.id.edsriogrande);
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,arreglo);
            opc.setAdapter(adapter);
            opc.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(EdsRioGrande.this, InfoEdsRioGrande.class);
                    intent.putExtra(InfoEdsRioGrande.EXTRA_TALLER_NUMERO,position);
