...
public class InfoEdsPorvenir extends AppCompatActivity {
    public static final String EXTRA_EDS_NUMERO="TallerNro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_eds_porvenir);
        int TallerNro=(Integer)getIntent().getExtras().get(EXTRA_EDS_NUMERO);
    ...
    public void verMapaEds(View view){
        Intent intent = new Intent(InfoEdsPorvenir.this, MapaEdsPorvenir.class);
        intent.putExtra(MapaEdsPorvenir.EXTRA_NOMBRE,tnro);
